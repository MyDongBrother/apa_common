...
{
template <>
LIBPROTOBUF_EXPORT ::google::protobuf::FieldMask *Arena::CreateMaybeMessage<
    ::google::protobuf::FieldMask>(Arena *);
} // namespace protobuf
} // namespace google
namespace google
{
                                                                         ...
                                                                         */
{
  public:
...
#if LANG_CXX11
    FieldMask(FieldMask &&from) noexcept : FieldMask() { *this = ::std::move(from); }
    ...
    inline FieldMask *New() const final { return CreateMaybeMessage<FieldMask>(NULL); }
