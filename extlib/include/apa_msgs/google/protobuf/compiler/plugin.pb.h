...
{
template <>
LIBPROTOC_EXPORT ::google::protobuf::compiler::CodeGeneratorRequest *Arena::
    CreateMaybeMessage<::google::protobuf::compiler::CodeGeneratorRequest>(Arena *);
template <>
LIBPROTOC_EXPORT ::google::protobuf::compiler::CodeGeneratorResponse *Arena::
    CreateMaybeMessage<::google::protobuf::compiler::CodeGeneratorResponse>(Arena *);
template <>
LIBPROTOC_EXPORT ::google::protobuf::compiler::CodeGeneratorResponse_File *Arena::
    CreateMaybeMessage<::google::protobuf::compiler::CodeGeneratorResponse_File>(Arena *);
template <>
LIBPROTOC_EXPORT ::google::protobuf::compiler::Version *Arena::CreateMaybeMessage<
    ::google::protobuf::compiler::Version>(Arena *);
} // namespace protobuf
} // namespace google
namespace google
{
                                                                     ...
                                                                     */
{
  public:
    ...
    inline Version *New() const final { return CreateMaybeMessage<Version>(NULL); }
...
// optional int32 major = 1;
inline bool Version::has_major() const { return (_has_bits_[0] & 0x00000002u) != 0; }
...
// optional int32 minor = 2;
inline bool Version::has_minor() const { return (_has_bits_[0] & 0x00000004u) != 0; }
...
// optional int32 patch = 3;
inline bool Version::has_patch() const { return (_has_bits_[0] & 0x00000008u) != 0; }
...
// optional string suffix = 4;
inline bool Version::has_suffix() const { return (_has_bits_[0] & 0x00000001u) != 0; }
...
inline void CodeGeneratorRequest::clear_file_to_generate() { file_to_generate_.Clear(); }
...
inline void CodeGeneratorRequest::set_has_parameter() { _has_bits_[0] |= 0x00000001u; }
inline void CodeGeneratorRequest::clear_has_parameter() { _has_bits_[0] &= ~0x00000001u; }
...
// repeated .google.protobuf.FileDescriptorProto proto_file = 15;
inline int CodeGeneratorRequest::proto_file_size() const { return proto_file_.size(); }
inline ::google::protobuf::FileDescriptorProto *CodeGeneratorRequest::mutable_proto_file(
    int index)
{
...
inline const ::google::protobuf::FileDescriptorProto &CodeGeneratorRequest::proto_file(
    int index) const
{
...
inline const ::google::protobuf::compiler::Version &CodeGeneratorRequest::
    _internal_compiler_version() const
{
    return *compiler_version_;
}
inline const ::google::protobuf::compiler::Version &CodeGeneratorRequest::
    compiler_version() const
{
...
inline ::google::protobuf::compiler::Version *CodeGeneratorRequest::
...
inline void CodeGeneratorResponse_File::set_has_name() { _has_bits_[0] |= 0x00000001u; }
    ...
    ::std::string *insertion_point)
{
    ...
    insertion_point_.SetAllocatedNoArena(
        &::google::protobuf::internal::GetEmptyStringAlreadyInited(), insertion_point);
...
inline void CodeGeneratorResponse::set_has_error() { _has_bits_[0] |= 0x00000001u; }
inline void CodeGeneratorResponse::clear_has_error() { _has_bits_[0] &= ~0x00000001u; }
