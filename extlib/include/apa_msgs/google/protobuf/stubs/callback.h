...
class MethodClosure2 : public Closure
{
  public:
    ...
    MethodClosure2(Class *object, MethodType method, bool self_deleting, Arg1 arg1,
                   Arg2 arg2)
        : object_(object),
          method_(method),
...
template <typename R, typename T, typename P1, typename P2, typename P3, typename P4,
          typename P5, typename A1, typename A2>
class MethodResultCallback_5_2 : public ResultCallback2<R, A1, A2>
{
  public:
    typedef R (T::*MethodType)(P1, P2, P3, P4, P5, A1, A2);
    MethodResultCallback_5_2(T *object, MethodType method, bool self_deleting, P1 p1,
...
inline Closure *NewCallback(Class *object, void (Class::*method)(Arg1, Arg2), Arg1 arg1,
                            Arg2 arg2)
{
    return new internal::MethodClosure2<Class, Arg1, Arg2>(object, method, true, arg1,
                                                           arg2);
}
...
inline Closure *NewPermanentCallback(Class *object, void (Class::*method)(Arg1, Arg2),
                                     Arg1 arg1, Arg2 arg2)
{
    return new internal::MethodClosure2<Class, Arg1, Arg2>(object, method, false, arg1,
                                                           arg2);
}
...
{
    return new internal::MethodResultCallback_5_2<R, T, P1, P2, P3, P4, P5, A1, A2>(
        object, function, false, p1, p2, p3, p4, p5);
}
