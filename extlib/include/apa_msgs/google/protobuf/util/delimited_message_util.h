...
bool LIBPROTOBUF_EXPORT SerializeDelimitedToFileDescriptor(const MessageLite &message,
                                                           int file_descriptor);
...
bool LIBPROTOBUF_EXPORT ParseDelimitedFromZeroCopyStream(MessageLite *message,
                                                         io::ZeroCopyInputStream *input,
                                                         bool *clean_eof);

bool LIBPROTOBUF_EXPORT ParseDelimitedFromCodedStream(MessageLite *message,
...
bool LIBPROTOBUF_EXPORT SerializeDelimitedToCodedStream(const MessageLite &message,
