...
class MatrixBase : public DenseBase<Derived>
{
  public:
    ...
    typedef Matrix<std::complex<RealScalar>, internal::traits<Derived>::ColsAtCompileTime,
                   1, ColMajor>
...
#undef EIGEN_DOC_UNARY_ADDONS
    ...
    template <unsigned int Mode>
    EIGEN_DEVICE_FUNC typename ConstTriangularViewReturnType<Mode>::Type triangularView()
        const;
    ...
    template <typename ResultType>
    inline void computeInverseWithCheck(ResultType &inverse, bool &invertible,
                                        const RealScalar &absDeterminantThreshold =
                                            NumTraits<Scalar>::dummy_precision()) const;
...
#define EIGEN_MATRIX_FUNCTION(ReturnType, Name, Description)                            \
     ...
     * function requires the <a href="unsupported/group__MatrixFunctions__Module.html"> \
     * unsupported MatrixFunctions module</a>. To compute the coefficient-wise          \
     * Description use ArrayBase::##Name . */                                           \
...
#define EIGEN_MATRIX_FUNCTION_1(ReturnType, Name, Description, Argument)                \
     ...
     * href="unsupported/group__MatrixFunctions__Module.html"> unsupported MatrixFunctions
     * module</a>.*/
