                      ...
                      bool transpose)
{
    ...
    // This first heuristic takes into account that the product kernel is fully optimized
    // when working with nr columns at once.
    ...
    // FIXME omp_get_num_threads()>1 only works for openmp, what if the user does not use
    // openmp?
