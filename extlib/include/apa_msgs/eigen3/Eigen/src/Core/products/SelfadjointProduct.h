...
struct selfadjoint_rank1_update<Scalar, Index, ColMajor, UpLo, ConjLhs, ConjRhs>
{
                    ...
                    const Scalar *vecY, const Scalar &alpha)
    {
        ...
        typedef typename internal::conditional<ConjLhs,
...
struct selfadjoint_rank1_update<Scalar, Index, RowMajor, UpLo, ConjLhs, ConjRhs>
{
    static void run(Index size, Scalar *mat, Index stride, const Scalar *vecX,
                    const Scalar *vecY, const Scalar &alpha)
    {
        selfadjoint_rank1_update<Scalar, Index, ColMajor, UpLo == Lower ? Upper : Lower,
                                 ConjRhs, ConjLhs>::run(size, mat, stride, vecY, vecX,
                                                        alpha);
    }
};
...
struct selfadjoint_product_selector<MatrixType, OtherType, UpLo, false>
{
                    ...
                    const typename MatrixType::Scalar &alpha)
    {
        ...
        typedef internal::gemm_blocking_space<IsRowMajor ? RowMajor : ColMajor, Scalar,
                                              Scalar, MatrixType::MaxColsAtCompileTime,
