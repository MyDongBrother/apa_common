 ...
 * speaking, for rectangular matrices one should speak of "trapezoid" parts. This class is
 * the return type of MatrixBase::triangularView() and SparseMatrixBase::triangularView(),
...
class TriangularView
    : public TriangularViewImpl<_MatrixType, _Mode,
                                typename internal::traits<_MatrixType>::StorageKind>
{
  public:
    typedef TriangularViewImpl<_MatrixType, _Mode,
                               typename internal::traits<_MatrixType>::StorageKind>
        Base;
  ...
  public:
     ...
     */
    template <bool Cond>
    EIGEN_DEVICE_FUNC inline typename internal::conditional<Cond, ConjugateReturnType,
...
// workaround MSVC ICE
    ...
    EIGEN_DEVICE_FUNC inline const internal::triangular_solve_retval<Side, TriangularView,
                                                                     Other>
    ...
    /** \returns a selfadjoint view of the referenced triangular part which must be either
     * \c #Upper or \c #Lower.
     *
    ...
    : public TriangularBase<TriangularView<_MatrixType, _Mode>>
{
  ...
  public:
     ...
     * other if \a Side==OnTheLeft (the default), or the right-inverse-multiply  \a other
     * * inverse(\c *this) if \a Side==OnTheRight.
     *
     ...
     *
     * This function returns an expression of the inverse-multiply and can works in-place
     * if it is assigned to the same matrix or vector \a other.
     *
 ...
 * The main difference is that the triangular, diagonal, and opposite parts are processed
 * through three different functions. \tparam UpLo must be either Lower or Upper \tparam
...
struct Assignment<DstXprType, SrcXprType, Functor, Triangular2Dense>
{
                                      ...
                                      const Functor &func)
    {
        call_triangular_assignment_loop<SrcXprType::Mode,
                                        (int(SrcXprType::Mode) & int(SelfAdjoint)) == 0>(
            dst, src, func);
    }
};
    ...
    MatrixBase<DenseDerived> &other) const
{
    ...
    internal::call_triangular_assignment_loop<
        Derived::Mode, (int(Derived::Mode) & int(SelfAdjoint)) == 0 /* SetOpposite */>(
