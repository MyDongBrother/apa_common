...
#endif
    // Do one or two steps of Newton-Raphson's to improve the approximation, depending on
    // the starting accuracy (either 2^-14 or 2^-28, depending on whether AVX512ER is
