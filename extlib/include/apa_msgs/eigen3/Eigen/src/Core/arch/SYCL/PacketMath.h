...
#define SYCL_PSTORE(scalar, packet_type, address_space_target, alignment)             \
    ...
    EIGEN_DEVICE_FUNC EIGEN_ALWAYS_INLINE void pstore##alignment(                     \
        typename cl::sycl::multi_ptr<                                                 \
            scalar, cl::sycl::access::address_space::address_space_target>::pointer_t \
            to,                                                                       \
...
struct get_base_packet<cl::sycl::cl_float4>
{
    ...
    {
        return cl::sycl::cl_float4(from[0 * stride], from[1 * stride], from[2 * stride],
                                   from[3 * stride]);
    }
...
template <>
EIGEN_DEVICE_FUNC EIGEN_ALWAYS_INLINE cl::sycl::cl_float4 pabs<cl::sycl::cl_float4>(
    const cl::sycl::cl_float4 &a)
{
...
{
    cl::sycl::cl_int4 condition(ifPacket.select[0] ? 0 : -1, ifPacket.select[1] ? 0 : -1,
