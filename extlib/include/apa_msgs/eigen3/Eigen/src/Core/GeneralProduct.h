...
struct product_type
{
    ...
    // the splitting into different lines of code here, introducing the _select enums and
    // the typedef below, is to work around an internal compiler error with gcc 4.1
    // and 4.2.
  private:
    enum
    {
...
struct gemv_static_vector_if<Scalar, Size, MaxSize, true>
{
    ...
    // => let's manually enforce alignment by allocating more data and return the address
    // of the first aligned element.
                           ...
                           const typename Dest::Scalar &alpha)
    {
        ...
        if (!MightCannotUseDest)
        {
            ...
            general_matrix_vector_product<
                Index, LhsScalar, LhsMapper, ColMajor, LhsBlasTraits::NeedToConjugate,
                RhsScalar, RhsMapper,
                    ...
                    const typename Dest::Scalar &alpha)
    {
        ...
        general_matrix_vector_product<Index, LhsScalar, LhsMapper, RowMajor,
            ...
            run(actualLhs.rows(), actualLhs.cols(),
                ...
                dest.col(0)
                    .innerStride(), // NOTE  if dest is not a vector at compile-time, then
...
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE const Product<Derived, OtherDerived> MatrixBase<
 ...
 *
 * \warning This version of the matrix product can be much much slower. So use it only if
 * you know what you are doing and that you measured a true speed improvement.
 *
