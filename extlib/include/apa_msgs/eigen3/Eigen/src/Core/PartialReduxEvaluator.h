...
struct packetwise_redux_impl<Func, Evaluator, CompleteUnrolling>
{
    ...
    EIGEN_DEVICE_FUNC static EIGEN_STRONG_INLINE PacketType run(const Evaluator &eval,
                                                                const Func &func,
                                                                Index /*size*/)
    {
...
struct packetwise_redux_impl<Func, Evaluator, NoUnrolling>
{
    ...
    template <typename PacketType>
    EIGEN_DEVICE_FUNC static PacketType run(const Evaluator &eval, const Func &func,
                                            Index size)
    {
        if (size == 0)
    ...
    : evaluator_base<PartialReduxExpr<ArgType, MemberOp, Direction>>
{
    ...
    enum
    {
        ...
        Alignment =
            0 // FIXME this will need to be improved once PartialReduxExpr is vectorized
    };
    ...
    EIGEN_STRONG_INLINE EIGEN_DEVICE_FUNC PacketType packet(Index idx) const
    {
        ...
        // packetByOuterInner do not make sense anymore in this context. So let's just by
        // pass "vectorization" in this case:
        if (PacketSize == 1)
