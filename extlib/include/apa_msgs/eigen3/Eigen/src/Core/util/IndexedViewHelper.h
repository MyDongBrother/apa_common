...
// IndexedViewCompatibleType/makeIndexedViewCompatible turn an arbitrary object of type T
// into something usable by MatrixSlice The generic implementation is a no-op
