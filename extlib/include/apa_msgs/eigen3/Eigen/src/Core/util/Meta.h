 ...
 * expression. It "returns" Eigen::Dynamic if the size cannot be resolved at compile-time
 * (default).
 *
...
struct result_of<Func(ArgType0, ArgType1)>
{
    ...
    typedef typename binary_result_of_select<Func, ArgType0, ArgType1, FunctorType>::type
        type;
};
...
struct has_unary_operator
{
    ...
    static meta_yes testFunctor(
        C const *,
        typename enable_if<(sizeof(return_ptr<C>()->operator()(IndexType(0))) > 0)>::type
            * = 0);
    static meta_no testFunctor(...);
...
/** \internal determines whether the product of two numeric types is allowed and what the
 * return type is */
template <typename T, typename U>
