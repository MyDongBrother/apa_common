 ...
 * decomposition of sparse matrices. The result is then used to solve linear leasts_square
 * systems. Clearly, a QR factorization is returned such that A*P = Q*R where :
 *
...
class SPQR : public SparseSolverBase<SPQR<_MatrixType>>
{
  ...
  public:
    ...
    void compute(const _MatrixType &matrix)
    {
        ...
        m_rank = SuiteSparseQR<Scalar>(m_ordering, pivotThreshold, col, &A, &m_cR, &m_E,
                                       &m_H, &m_HPinv, &m_HTau, &m_cc);
