...
/**
 * Class TopicListener, it should be used by the end user to implement specific callbacks
 * to certain actions.
 *
...
class RTPS_DllAPI TopicListener
{
  public:
     ...
     * performed when another topic exists with the same name but different
     * characteristics.
     *
     * @param topic Topic
