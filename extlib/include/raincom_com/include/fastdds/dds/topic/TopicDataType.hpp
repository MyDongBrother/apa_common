...
/**
 * Class TopicDataType used to provide the DomainRTPSParticipant with the methods to
...
class TopicDataType
{
  public:
     ...
     * @return True if correct.
     */
    RTPS_DllAPI virtual bool getKey(void *data, fastrtps::rtps::InstanceHandle_t *ihandle,
     ...
     */
    RTPS_DllAPI inline const std::shared_ptr<xtypes::TypeInformation> type_information()
        const
    {
     ...
     */
    RTPS_DllAPI inline void type_information(const xtypes::TypeInformation &info)
    {
     ...
     *
     * @param memory Pointer to the memory location where the sample should be
     * constructed.
     *
