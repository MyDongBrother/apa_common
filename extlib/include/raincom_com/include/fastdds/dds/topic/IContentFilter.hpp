...
struct IContentFilter
{
    ...
    /**
     * Selected information from the cache change that is passed to the content filter
     * object on payload evaluation.
     */
     ...
     * @param [in]  reader_guid  The GUID of the reader for which the filter is being
     * evaluated.
     *
