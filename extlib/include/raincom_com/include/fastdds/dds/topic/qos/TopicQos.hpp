 ...
 * during the Endpoint Discovery Protocol, not all of the behaviour associated with them
 * has been implemented in the library. Please consult each of them to check for
 * implementation details and default values.
 *
...
class TopicQos
{
  public:
     ...
     */
    const TopicDataQosPolicy &topic_data() const { return topic_data_; }
     ...
     * @return TopicDataQos reference
     */
    TopicDataQosPolicy &topic_data() { return topic_data_; }
     ...
     */
    void topic_data(const TopicDataQosPolicy &value) { topic_data_ = value; }
     ...
     * @return DurabilityServiceQos reference
     */
    DurabilityServiceQosPolicy &durability_service() { return durability_service_; }
     ...
     */
    const LatencyBudgetQosPolicy &latency_budget() const { return latency_budget_; }
     ...
     * @return LatencyBudgetQos reference
     */
    LatencyBudgetQosPolicy &latency_budget() { return latency_budget_; }
     ...
     * @return DestinationOrderQos reference
     */
    DestinationOrderQosPolicy &destination_order() { return destination_order_; }
     ...
     * @return TransportPriorityQos reference
     */
    TransportPriorityQosPolicy &transport_priority() { return transport_priority_; }
     ...
     */
    const DataRepresentationQosPolicy &representation() const { return representation_; }
     ...
     * @return DataRepresentationQosPolicy reference
     */
    DataRepresentationQosPolicy &representation() { return representation_; }
