 ...
 */
class DomainParticipantListener : public PublisherListener,
                                  ...
                                  public TopicListener
{
  public:
     ...
     * @param info Remote participant authentication information. User can take ownership
     * of the object.
     */
     ...
     */
    virtual void on_subscriber_discovery(DomainParticipant *participant,
     ...
     */
    virtual void on_publisher_discovery(DomainParticipant *participant,
     ...
     * shared_ptr nature. For example: fastrtps::types::TypeIdentifier new_type_id =
     * \*identifier;
     */
