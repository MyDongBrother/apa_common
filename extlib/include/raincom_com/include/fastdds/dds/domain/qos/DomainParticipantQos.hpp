...
/**
 * Class DomainParticipantQos, contains all the possible Qos that can be set for a
 * determined participant. Please consult each of them to check for implementation details
 * and default values.
 *
...
class DomainParticipantQos
{
  public:
    ...
    RTPS_DllAPI DomainParticipantQos()
    {
        ...
        /*
         * In the case of Statistics, the following properties are set with an empty
         * value. This is because if these properties are set and empty during the
         * enabling of the DomainParticipant, they are fill with the default mechanism
         */
     ...
     */
    const UserDataQosPolicy &user_data() const { return user_data_; }
     ...
     * @return UserDataQosPolicy reference
     */
    UserDataQosPolicy &user_data() { return user_data_; }
     ...
     */
    void user_data(const UserDataQosPolicy &value) { user_data_ = value; }
     ...
     */
    const EntityFactoryQosPolicy &entity_factory() const { return entity_factory_; }
     ...
     * @return EntityFactoryQosPolicy reference
     */
    EntityFactoryQosPolicy &entity_factory() { return entity_factory_; }
     ...
     */
    void entity_factory(const EntityFactoryQosPolicy &value) { entity_factory_ = value; }
     ...
     */
    const ParticipantResourceLimitsQos &allocation() const { return allocation_; }
     ...
     * @return ParticipantResourceLimitsQos reference
     */
    ParticipantResourceLimitsQos &allocation() { return allocation_; }
     ...
     */
    const PropertyPolicyQos &properties() const { return properties_; }
     ...
     * @return PropertyPolicyQos reference
     */
    PropertyPolicyQos &properties() { return properties_; }
     ...
     */
    void properties(const PropertyPolicyQos &properties) { properties_ = properties; }
     ...
     */
    const WireProtocolConfigQos &wire_protocol() const { return wire_protocol_; }
     ...
     * @return WireProtocolConfigQos reference
     */
    WireProtocolConfigQos &wire_protocol() { return wire_protocol_; }
     ...
     */
    const TransportConfigQos &transport() const { return transport_; }
     ...
     * @return TransportConfigQos reference
     */
    TransportConfigQos &transport() { return transport_; }
     ...
     */
    void transport(const TransportConfigQos &transport) { transport_ = transport; }
