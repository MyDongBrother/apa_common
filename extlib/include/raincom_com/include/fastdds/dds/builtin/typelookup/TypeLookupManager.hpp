...
/**
 * Class TypeLookupManager that implements the TypeLookup Service described in the
 * DDS-XTYPES 1.2 specification.
 * @ingroup XTYPES
 */
class TypeLookupManager
{
  ...
  private:
    ...
    bool recv_reply(fastrtps::rtps::CacheChange_t &change, TypeLookup_Reply &rep) const;
