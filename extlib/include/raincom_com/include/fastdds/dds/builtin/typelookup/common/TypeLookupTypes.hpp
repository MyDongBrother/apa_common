...
struct TypeLookup_getTypes_In
{
    ...
    RTPS_DllAPI static size_t getCdrSerializedSize(const TypeLookup_getTypes_In &data,
...
struct TypeLookup_getTypes_Out
{
    ...
    RTPS_DllAPI static size_t getCdrSerializedSize(const TypeLookup_getTypes_Out &data,
                                                   size_t current_alignment = 0);
...
class TypeLookup_getTypes_Result
{
  public:
    ...
    RTPS_DllAPI static size_t getCdrSerializedSize(const TypeLookup_getTypes_Result &data,
                                                   size_t current_alignment = 0);
...
class TypeLookup_getTypeDependencies_In
{
  public:
    ...
    RTPS_DllAPI static size_t getCdrSerializedSize(
        const TypeLookup_getTypeDependencies_In &data, size_t current_alignment = 0);
...
class TypeLookup_getTypeDependencies_Out
{
  public:
    ...
    RTPS_DllAPI static size_t getCdrSerializedSize(
        const TypeLookup_getTypeDependencies_Out &data, size_t current_alignment = 0);
...
class TypeLookup_getTypeDependencies_Result
{
  public:
    ...
    RTPS_DllAPI static size_t getCdrSerializedSize(
        const TypeLookup_getTypeDependencies_Result &data, size_t current_alignment = 0);
...
class TypeLookup_RequestPubSubType : public TopicDataType
{
  public:
    ...
    bool serialize(void *data, fastrtps::rtps::SerializedPayload_t *payload) override;

    bool deserialize(fastrtps::rtps::SerializedPayload_t *payload, void *data) override;
