...
//! @brief Specifies the behavior of the DataWriter with regards to the lifecycle of the
...
class WriterDataLifecycleQosPolicy
{
  public:
    ...
    {
        return (this->autodispose_unregistered_instances ==
                b.autodispose_unregistered_instances);
    }

  public:
    /**
     * @brief Controls whether a DataWriter will automatically dispose instances each time
     * they are unregistered. The setting autodispose_unregistered_instances = TRUE
     * indicates that unregistered instances will also be considered disposed. <br> By
     * default, true.
     */
