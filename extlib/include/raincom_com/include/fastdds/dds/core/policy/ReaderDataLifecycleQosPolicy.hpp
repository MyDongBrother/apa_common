...
//! @brief Specifies the behavior of the DataReader with regards to the lifecycle of the
//! data-instances it manages.
...
class ReaderDataLifecycleQosPolicy
{
  public:
    ...
    ReaderDataLifecycleQosPolicy()
        : autopurge_no_writer_samples_delay(TIME_T_INFINITE_SECONDS,
                                            TIME_T_INFINITE_NANOSECONDS),
          autopurge_disposed_samples_delay(TIME_T_INFINITE_SECONDS,
                                           TIME_T_INFINITE_NANOSECONDS)
    {
    }
    ...
    {
        return (this->autopurge_no_writer_samples_delay ==
                b.autopurge_no_writer_samples_delay) &&
  ...
  public:
    /**
     * @brief Indicates the duration the DataReader must retain information regarding
     * instances that have the instance_state NOT_ALIVE_NO_WRITERS. <br> By default,
     * c_TimeInfinite.
     */
    Duration_t autopurge_no_writer_samples_delay;
    /**
     * @brief Indicates the duration the DataReader must retain information regarding
     * instances that have the instance_state NOT_ALIVE_DISPOSED. <br> By default,
     * c_TimeInfinite.
     */
