...
/**
 * @brief The GuardCondition class is a specific Condition whose trigger_value is
 * completely under the control of the application.
 *
 * The purpose of the GuardCondition is to provide the means for the application to
 * manually wakeup a WaitSet. This is accomplished by attaching the GuardCondition to the
 * WaitSet and then setting the trigger_value by means of the set_trigger_value operation.
 *
 */
