...
/**
 * @brief The StatusCondition class is a specific Condition that is associated with each
 * Entity.
 *
 */
class StatusCondition final : public Condition
{
  public:
    ...
    /**
     * @brief Defines the list of communication statuses that are taken into account to
     * determine the trigger_value
    ...
    /**
     * @brief Retrieves the list of communication statuses that are taken into account to
     * determine the trigger_value
    ...
    detail::StatusConditionImpl *get_impl() const { return impl_.get(); }
