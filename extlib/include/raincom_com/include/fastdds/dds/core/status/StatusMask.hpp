...
class RTPS_DllAPI StatusMask : public std::bitset<FASTDDS_STATUS_COUNT>
{
  public:
     ...
     */
    StatusMask() : std::bitset<FASTDDS_STATUS_COUNT>() {}
     ...
     */
    explicit StatusMask(uint32_t mask) : std::bitset<FASTDDS_STATUS_COUNT>(mask) {}
     ...
     */
    inline static StatusMask all() { return StatusMask(0x80007fe7u); }
     ...
     */
    inline static StatusMask none() { return StatusMask(0u); }
  ...
  public:
     ...
     */
    inline static StatusMask inconsistent_topic() { return StatusMask(0x00000001 << 0u); }
    ...
    /**
     * Get the StatusMask associated with
     ...
     */
    inline static StatusMask sample_lost() { return StatusMask(0x00000001 << 7u); }
     ...
     */
    inline static StatusMask sample_rejected() { return StatusMask(0x00000001 << 8u); }
     ...
     */
    inline static StatusMask data_on_readers() { return StatusMask(0x00000001 << 9u); }
     ...
     */
    inline static StatusMask data_available() { return StatusMask(0x00000001 << 10u); }
     ...
     */
    inline static StatusMask liveliness_lost() { return StatusMask(0x00000001 << 11u); }
