...
/**
 * @brief The Entity class is the abstract base class for all the objects that support QoS
...
/**
 * @brief The DomainEntity class is a subclass of Entity created in order to differentiate
 * between DomainParticipants and the rest of Entities
 */
