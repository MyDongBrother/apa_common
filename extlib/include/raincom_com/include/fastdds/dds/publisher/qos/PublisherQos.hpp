...
/**
 * Class PublisherQos, containing all the possible Qos that can be set for a determined
 * Publisher. Although these values can be set and are transmitted during the Endpoint
