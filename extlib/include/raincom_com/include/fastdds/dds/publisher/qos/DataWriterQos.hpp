...
/**
 * Class DataWriterQos, containing all the possible Qos that can be set for a determined
 * DataWriter. Although these values can be  and are transmitted during the Endpoint
  ...
  public:
    ...
    RTPS_DllAPI bool operator==(const DataWriterQos &b) const
    {
        return (this->durability_ == b.durability()) &&
               ...
               (this->lifespan_ == b.lifespan()) && (this->user_data_ == b.user_data()) &&
     ...
     */
    RTPS_DllAPI void latency_budget(const LatencyBudgetQosPolicy &latency_budget)
    {
     ...
     */
    RTPS_DllAPI void destination_order(const DestinationOrderQosPolicy &destination_order)
    {
     ...
     */
    RTPS_DllAPI DataRepresentationQosPolicy &representation() { return representation_; }
     ...
     */
    RTPS_DllAPI void representation(const DataRepresentationQosPolicy &representation)
    {
     ...
     */
    RTPS_DllAPI void endpoint(const RTPSEndpointQos &endpoint) { endpoint_ = endpoint; }
