...
/**
 * Class DataWriterListener, allows the end user to implement callbacks triggered by
 * certain events.
...
class RTPS_DllAPI DataWriterListener
{
  public:
    ...
    /**
     * This method is called when the Publisher is matched (or unmatched) against an
     * endpoint.
     *
