...
/**
 * Class ReaderQos, contains all the possible Qos that can be set for a determined
  ...
  public:
    ...
    bool operator==(const ReaderQos &b) const
    {
        return (m_durability == b.m_durability) && (m_deadline == b.m_deadline) &&
               ...
               (m_liveliness == b.m_liveliness) && (m_reliability == b.m_reliability) &&
               ...
               (m_presentation == b.m_presentation) && (m_partition == b.m_partition) &&
               (m_topicData == b.m_topicData) && (m_groupData == b.m_groupData) &&
               ...
               (representation == b.representation) && (data_sharing == b.data_sharing);
    }
     ...
     * @param first_time Boolean indicating whether is the first time (If not some
    ...
    /**
     * Check if the Qos can be update with the values provided. This method DOES NOT
     * update anything.
