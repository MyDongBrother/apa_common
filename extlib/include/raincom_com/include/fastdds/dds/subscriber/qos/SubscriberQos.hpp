...
/**
 * Class SubscriberQos, contains all the possible Qos that can be set for a determined
 * Subscriber. Although these values can be set and are transmitted during the Endpoint
  ...
  public:
    ...
    bool operator==(const SubscriberQos &b) const
    {
        return (presentation_ == b.presentation_) && (partition_ == b.partition_) &&
               (group_data_ == b.group_data_) && (entity_factory_ == b.entity_factory_);
    }
     ...
     */
    const PresentationQosPolicy &presentation() const { return presentation_; }
     ...
     * @return PresentationQosPolicy reference
     */
    PresentationQosPolicy &presentation() { return presentation_; }
     ...
     */
    const GroupDataQosPolicy &group_data() const { return group_data_; }
     ...
     * @return GroupDataQosPolicy reference
     */
    GroupDataQosPolicy &group_data() { return group_data_; }
     ...
     */
    void group_data(const GroupDataQosPolicy &group_data) { group_data_ = group_data; }
