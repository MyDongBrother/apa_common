...
struct SharedMemTransportDescriptor : public TransportDescriptorInterface
{
    ...
    RTPS_DllAPI void segment_size(uint32_t segment_size) { segment_size_ = segment_size; }
    ...
    RTPS_DllAPI uint32_t port_queue_capacity() const { return port_queue_capacity_; }
