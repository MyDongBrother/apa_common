 ...
 * Publisher-Subscriber API has other fields to define this values (HistoryQosPolicy and
...
class RTPS_DllAPI HistoryAttributes
{
  public:
    ...
    /**
     * Maximum number of reserved caches. Default value is 0 that indicates to keep
     * reserving until something breaks.
     */
    int32_t maximumReservedCaches;

    /**
     * Number of extra caches that can be reserved for other purposes than the history.
     * For example, on a full history, the writer could give as many as these to be used
     * by the application but they will not be able to be inserted in the history unless
     * some cache from the history is released.
     *
     * Default value is 1.
     */
