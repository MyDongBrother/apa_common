...
struct VariableLengthDataLimits
{
    ...
    //! Defines the maximum size (in octets) of properties data in the local or remote
    //! participant
    size_t max_properties = 0;
    //! Defines the maximum size (in octets) of user data in the local or remote
    //! participant
...
struct RTPSParticipantAllocationAttributes
{
    ...
    //! @return the allocation config for the total of readers in the system (participants
    //! * readers)
    ...
    //! @return the allocation config for the total of writers in the system (participants
    //! * writers)
    ...
    bool operator==(const RTPSParticipantAllocationAttributes &b) const
    {
        return (this->locators == b.locators) && (this->participants == b.participants) &&
               (this->readers == b.readers) && (this->writers == b.writers) &&
