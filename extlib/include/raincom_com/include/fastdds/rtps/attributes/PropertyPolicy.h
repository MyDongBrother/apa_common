...
class PropertyPolicy
{
  public:
    ...
    RTPS_DllAPI BinaryPropertySeq &binary_properties() { return binary_properties_; }
...
class PropertyPolicyHelper
{
  public:
    ...
    RTPS_DllAPI static PropertyPolicy get_properties_with_prefix(
        const PropertyPolicy &property_policy, const std::string &prefix);
    ...
    RTPS_DllAPI static const std::string *find_property(
        const PropertyPolicy &property_policy, const std::string &name);
};
