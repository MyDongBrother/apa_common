...
typedef enum DiscoveryProtocol
{
    ...
    EXTERNAL,
    /*!<
        A user defined PDP subclass object must be provided in the attributes that deals
       with the discovery. Framework is not responsible of this object lifetime.
     */
    ...
    SERVER, /*!< The participant will behave as a server concerning discovery operation.
                 Discovery operation is volatile (discovery handshake must take place if
               shutdown). */
    BACKUP, /*!< The participant will behave as a server concerning discovery operation.
                Discovery operation persist on a file (discovery handshake wouldn't repeat
               if shutdown). */
    SUPER_CLIENT /*!< The participant will behave as a client concerning all internal
                    behaviour. Remote servers will treat it as a server and will share
                    every discovery information. */
...
/**
 * Class SimpleEDPAttributes, to define the attributes of the Simple Endpoint Discovery
 * Protocol.
...
/**
 * Class DiscoverySettings, to define the attributes of the several discovery protocols
 * available
 * @ingroup RTPS_ATTRIBUTES_MODULE
 */
...
class DiscoverySettings
{
  public:
    ...
    /**
     * The period for the RTPSParticipant to send its Discovery Message to all other
  ...
  private:
    ...
    //! use_STATIC_EndpointDiscoveryProtocol=true This string could contain a filename or
...
/**
 * Class BuiltinAttributes, to define the behavior of the RTPSParticipant builtin
 * protocols.
 * @ingroup RTPS_ATTRIBUTES_MODULE
 */
