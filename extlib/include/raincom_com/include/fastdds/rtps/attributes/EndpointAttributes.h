...
/**
 * Structure EndpointAttributes, describing the attributes associated with an RTPS
 * Endpoint.
...
class EndpointAttributes
{
  ...
  private:
    ...
    //! Entity ID, if the user want to specify the EntityID of the enpoint, default value
    //! -1.
    int16_t m_entityID;
