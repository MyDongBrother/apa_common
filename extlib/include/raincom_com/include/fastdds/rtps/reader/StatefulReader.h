...
/**
 * Class StatefulReader, specialization of RTPSReader than stores the state of the matched
 * writers.
...
class StatefulReader : public RTPSReader
{
  ...
  public:
     ...
     * @return True if read.
     */
    bool nextUnreadCache(CacheChange_t **change, WriterProxy **wpout = nullptr) override;
     ...
     */
    inline size_t getMatchedWritersSize() const { return matched_writers_.size(); }
     ...
     */
    void send_acknack(const WriterProxy *writer, RTPSMessageSenderInterface *sender,
     ...
     */
    bool send_sync_nts(CDRMessage_t *message, const Locators &locators_begin,
  ...
  private:
    ...
    void remove_changes_from(const GUID_t &writerGUID, bool is_payload_pool_lost = false);
