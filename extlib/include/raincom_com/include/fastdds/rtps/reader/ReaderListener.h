...
/**
 * Class ReaderListener, to be used by the user to override some of is virtual method to
 * program actions to certain events.
...
class RTPS_DllAPI ReaderListener
{
  public:
     ...
     */
    virtual void onReaderMatched(RTPSReader *reader,
    ...
    virtual void on_liveliness_changed(
        RTPSReader *reader, const eprosima::fastdds::dds::LivelinessChangedStatus &status)
    {
        static_cast<void>(reader);
    ...
    /**
     * This method is called when the reader detects that one or more samples have been
     * lost.
     *
     * @param reader                         Pointer to the RTPSReader.
     * @param sample_lost_since_last_update  The number of samples that were lost since
     * the last time this method was called for the same reader.
     */
    ...
    /**
     * @brief Method called when the discovery information of a writer regarding a reader
     * changes.
     *
     * @param reader       The reader.
     * @param reason       The reason motivating this method to be called.
     * @param writer_guid  The GUID of the writer for which the discovery information
     * changed.
     * @param writer_info  Discovery information about the writer. Will be @c nullptr for
     * reason @c REMOVED_WRITER.
     */
