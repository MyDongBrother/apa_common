 ...
 *
 * This descriptor is used to define the configuration applied in the creation of a flow
 * controller.
 * @since 2.4.0
 */
struct FlowControllerDescriptor
{
    ...
    //!
    //! Period of time on which the flow controller is allowed to send
    //! max_bytes_per_period. Default value: 100ms.
