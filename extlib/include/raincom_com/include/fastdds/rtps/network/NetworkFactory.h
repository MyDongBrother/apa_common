...
class NetworkFactory
{
  public:
     ...
     * its associated descriptor type. This is particularly useful for user-defined
     * transports.
     */
     ...
     *
     * @param descriptor Structure that defines all initial configuration for a given
     * transport.
     * @param properties Optional policy to specify additional parameters for the created
     * transport.
     */
    ...
    /**
     * Walk over the list of transports, opening every possible channel that can send
     * through the given locator and returning a vector of Sender Resources associated
     * with it.
    ...
    /**
     * Walk over the list of transports, opening every possible channel that we can listen
     * to from the given locator, and returns a vector of Receiver Resources for this
     * goal.
    ...
    /**
     * Fill ret_locators with the list of all possible locators in the local machine at
     * the given physical_port of the locator_kind. Return if found any.
     * */
     ...
     * */
    bool getDefaultMetatrafficUnicastLocators(LocatorList_t &locators,
                                              uint32_t metatraffic_unicast_port) const;

    /**
     * Fill the locator with the metatraffic multicast configuration.
     * */
    bool fillMetatrafficMulticastLocator(Locator_t &locator,
