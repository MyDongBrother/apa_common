...
/**
 * RAII object that encapsulates the Receive operation over one channel in an unknown
 * transport. A Receiver resource is always univocally associated to a transport channel;
 * the act of constructing a Receiver Resource opens the channel and its destruction
 * closes it.
