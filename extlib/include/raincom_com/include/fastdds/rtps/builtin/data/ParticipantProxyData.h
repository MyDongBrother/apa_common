...
/**
 * ParticipantProxyData class is used to store and convert the information Participants
 *send to each other during the PDP phase.
...
class ParticipantProxyData
{
  public:
    ...
    /**
     * Retrieves BACKUP server stamp. On deserialization hints if lease duration must be
     * enforced
     * @return GUID
     */
    ...
    const std::chrono::microseconds &lease_duration() const { return lease_duration_; }
