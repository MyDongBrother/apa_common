...
class WriterProxyData
{
  public:
    ...
    RTPS_DllAPI void persistence_guid(const GUID_t &guid) { persistence_guid_ = guid; }
    ...
    {
        persistence_guid_.entityId = persistence_guid_.guidPrefix != c_GuidPrefix_Unknown
                                         ? nid
                                         : c_EntityId_Unknown;
    }
