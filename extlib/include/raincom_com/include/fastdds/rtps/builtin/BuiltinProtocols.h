...
/**
 * Class BuiltinProtocols that contains builtin endpoints implementing the discovery and
 * liveliness protocols.
...
class BuiltinProtocols
{
  ...
  public:
    ...
    //! Stop the RTPSParticipant Announcement (used in tests to avoid multiple packets
    //! being send)
