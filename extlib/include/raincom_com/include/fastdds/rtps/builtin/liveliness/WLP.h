...
/**
 * Class WLP that implements the Writer Liveliness Protocol described in the RTPS
 * specification.
...
class WLP
{
  ...
  private:
    ...
    //! A boolean indicating that there is at least one reader requesting automatic
    //! liveliness
    ...
    //! A class used by readers in this participant to keep track of liveliness of matched
    //! writers
    ...
    /**
     * @brief A method invoked by pub_liveliness_manager_ to inform that a writer changed
     * its liveliness
     ...
     */
    void pub_liveliness_changed(const GUID_t &writer, const LivelinessQosPolicyKind &kind,
                                const Duration_t &lease_duration, int32_t alive_change,
                                int32_t not_alive_change);

    /**
     * @brief A method invoked by sub_liveliness_manager_ to inform that a writer changed
     * its liveliness
     * @param writer The writer losing liveliness
     ...
     * @param not_alive_change The change in the not alive count
     */
    void sub_liveliness_changed(const GUID_t &writer, const LivelinessQosPolicyKind &kind,
                                const Duration_t &lease_duration, int32_t alive_change,
                                int32_t not_alive_change);
     ...
     * @param not_alive_change The change requested for not alive count. Should be -1, 0
     * or +1
     */
