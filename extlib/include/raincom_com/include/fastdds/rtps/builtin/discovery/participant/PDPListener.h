...
/**
 * Class PDPListener, specification used by the PDP to perform the History check when a
 * new message is received. This class is implemented in order to use the same structure
 * than with any other RTPSReader.
