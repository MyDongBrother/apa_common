...
class EDPStatic : public EDP
{
  public:
    ...
    /**
     * New Remote Writer has been found and this method process it and calls the pairing
     * methods.
    ...
    /**
     * New Remote Reader has been found and this method process it and calls the pairing
     * methods.
     * @param participant_guid  GUID of the participant.
     * @param participant_name  Name of the participant.
     * @param user_id           User Id.
    ...
    /**
     * This method checks the provided entityId against the topic type to see if it
     *matches
