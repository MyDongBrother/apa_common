...
/**
 * Class PDPSimple that implements the SimpleRTPSParticipantDiscoveryProtocol as defined
 * in the RTPS specification.
...
class PDPSimple : public PDP
{
  public:
     ...
     */
    ParticipantProxyData *createParticipantProxyData(const ParticipantProxyData &p,
     ...
     */
    bool newRemoteEndpointStaticallyDiscovered(const GUID_t &pguid, int16_t userDefinedId,
                                               EndpointKind_t kind);
