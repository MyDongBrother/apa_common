...
class CryptoKeyExchange
{
  public:
    ...
    /**
     * Creates Crypto Tokens containing the info to decrypt text encoded by the local
     * Participant. To be sent to the remote participant.
     ...
     * @param remote_participant_crypto CryptoHangle returned by a previous call to
    ...
    /**
     * Configures the Cryptographic Plugin with the material needed to interpret messages
     * coming from the remote crypto.
     * @param local_participant_crypto CryptoHandle returned by a previous call to
     * register_local_participant.
     * @param remote_participant_crypto CryptoHandle returned by a previous call to
     * register_matched_remote_participant.
     * @param remote_participant_tokens CryptoToken sequence received from the remote
     * Participant
     * @param exception (out) Security exception
    ...
    /**
     * Creates CryptoTokens containing the info to decrypt text encoded by the local
     * DataWriter.
    ...
    /**
     * Configures the Cryptographic Plugin with the material needed to interpret messages
     * coming from the remote DataReader.
    ...
    /**
     * Configures the Cryptographic Plugin with the material needed to interpret messages
     * coming from the remote DataWriter.
     * @param local_datareader_crypto
     * @param remote_datawriter_crypto
