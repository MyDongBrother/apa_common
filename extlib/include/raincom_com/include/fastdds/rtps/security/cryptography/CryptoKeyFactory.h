...
class CryptoKeyFactory
{
  public:
     ...
     * @param participant_properties Combination of PropertyQoSPolicy and contents of
     * AccessControl
    ...
    virtual DatawriterCryptoHandle *register_local_datawriter(
        ParticipantCryptoHandle &participant_crypto, const PropertySeq &datawriter_prop,
        const EndpointSecurityAttributes &datawriter_sec_attr,
        SecurityException &exception) = 0;

    /**
     * Register a remote DataReader that has been granted permission to match with the
     * local DataWriter. Creates cryptographic material to encript/decrypt messages from
     * and towards that DataReader.
     ...
     * Participant) with the Cryptographic Plugin. Creates crypto material to encode
     * messages when the encryption is independent of the targeted DataWriter
     * @param participant_crypto Returned by a prior call to register_local_participant
     * @param datareader_properties Combination of PropertyQosPolicy and the contents of
     * AccessControl
    ...
    /**
     * Register a remote DataWriter that has been granted permission to match with a local
     * DataReader. Creates crypto material to decrypt messages coming from and encode
     * messages going towards that datareader
    ...
    /**
     * Releases resources associated with a DataWriter. The Crypto Handle may become
     * unusable after this
    ...
    /**
     * Releases resources associated with a DataReader. The Crypto Handle may become
     * unusable after this
