...
class MessageIdentity
{
  public:
    ...
    MessageIdentity(MessageIdentity &&mi)
        : source_guid_(std::move(mi.source_guid_)), sequence_number_(mi.sequence_number_)
    {
    }
    ...
    void source_guid(GUID_t &&source_guid) { source_guid_ = std::move(source_guid); }

    const GUID_t &source_guid() const { return source_guid_; }

    GUID_t &source_guid() { return source_guid_; }

    void sequence_number(int64_t sequence_number) { sequence_number_ = sequence_number; }
...
class ParticipantGenericMessage
{
  public:
    ...
    MessageIdentity &related_message_identity() { return related_message_identity_; }
    ...
    const GUID_t &destination_endpoint_key() const { return destination_endpoint_key_; }
    ...
    void message_data(const DataHolderSeq &message_data) { message_data_ = message_data; }
...
class ParticipantGenericMessageHelper
{
  public:
                                  ...
                                  size_t current_alignment = 0)
    {
        ...
        current_alignment +=
            4 + alignment(current_alignment, 4) + message.message_class_id().size() + 1;
        current_alignment +=
            DataHolderHelper::serialized_size(message.message_data(), current_alignment);
