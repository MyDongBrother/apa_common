...
class Logging
{
  ...
  protected:
    ...
    virtual bool convert(const LoggingLevel log_level, const std::string &message,
                         const std::string &category, BuiltinLoggingType &builtin_msg,
...
template <typename Stream>
bool Logging::compose_header(Stream &header, const BuiltinLoggingType &builtin_msg,
                             SecurityException &exception) const
{
...
#define __FASTRTPS_SECURITY_LOGGING(LEVEL, CLASS, MESSAGE, EXCEPTION)                  \
    ...
    {                                                                                  \
        ...
        if (logger)                                                                    \
        {                                                                              \
            logger->log(LEVEL, MESSAGE, std::string(CLASS ",") + __func__, EXCEPTION); \
        }                                                                              \
        else                                                                           \
        {                                                                              \
            switch (LEVEL)                                                             \
...
#define SECURITY_LOGGING(...)                                               \
    __FASTRTPS_EXPAND(                                                      \
        __FASTRTPS_MACRO_SELECTOR(__VA_ARGS__, __FASTRTPS_SECURITY_LOGGING, \
