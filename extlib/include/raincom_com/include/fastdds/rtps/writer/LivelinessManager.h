...
/**
 * @brief A class managing the liveliness of a set of writers. Writers are represented by
 * their LivelinessData
...
class LivelinessManager
{
  public:
     ...
     * @param manage_automatic True to manage writers with automatic liveliness, false
     * otherwise
     */
     ...
     */
    bool remove_writer(GUID_t guid, LivelinessQosPolicyKind kind,
  ...
  private:
     ...
     * liveliness
     * @details This method is public for testing purposes but it should not be used from
     * outside this class
