...
/*!
 * Class used by writers to inform a RTPSMessageGroup object which remote participants
 * will be addressees of next RTPS submessages.
 */
class LocatorSelectorSender : public RTPSMessageSenderInterface
{
  public:
    LocatorSelectorSender(RTPSWriter &writer,
     ...
     * Lock the object.
     *
     * This kind of object needs to be locked because could be used outside the writer's
     * mutex.
     */
