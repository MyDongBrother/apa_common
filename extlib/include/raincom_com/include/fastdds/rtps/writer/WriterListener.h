...
/**
 * Class WriterListener with virtual method so the user can implement callbacks to certain
 * events.
...
class RTPS_DllAPI WriterListener
{
  public:
    ...
    /**
     * This method is called when a new Reader is matched with this Writer by the builtin
     * protocols
    ...
    virtual void onWriterMatched(
        RTPSWriter *writer, const eprosima::fastdds::dds::PublicationMatchedStatus &info)
    {
        static_cast<void>(writer);
        static_cast<void>(info);
    }
    ...
    /**
     * This method is called when all the readers matched with this Writer acknowledge
     * that a cache change has been received.
     * @param writer Pointer to the RTPSWriter.
     * @param change Pointer to the affected CacheChange_t.
     */
    virtual void onWriterChangeReceivedByAll(RTPSWriter *writer, CacheChange_t *change)
    {
        static_cast<void>(writer);
    ...
    /**
     * @brief Method called when the discovery information of a reader regarding a writer
     * changes.
     *
     * @param writer       The writer.
     * @param reason       The reason motivating this method to be called.
     * @param reader_guid  The GUID of the reader for which the discovery information
     * changed.
     * @param reader_info  Discovery information about the reader. Will be @c nullptr for
     * reason @c REMOVED_READER.
     */
