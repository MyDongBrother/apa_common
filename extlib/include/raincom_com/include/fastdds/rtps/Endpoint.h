 ...
 * Although the RTPSParticipant is also defined as an endpoint in the RTPS specification,
 * in this implementation the RTPSParticipant class **does not** inherit from the endpoint
 * class. Each Endpoint object owns a pointer to the RTPSParticipant it belongs to.
