...
//!@brief Structure SubmessageHeader_t, used to contain the header information of a
//!submessage.
struct SubmessageHeader_t
{
    ...
    SubmessageHeader_t() : submessageId(0), submessageLength(0), flags(0), is_last(false)
    {
    }
};
