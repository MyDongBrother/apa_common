...
class RTPSMessageCreator
{
  public:
     ...
     * Depending on the function a complete message (with RTPS Header is created) or only
     * the submessage.
    ...
    static bool addMessageDataFrag(CDRMessage_t *msg, GuidPrefix_t &guidprefix,
                                   const CacheChange_t *change, uint32_t fragment_number,
                                   TopicKind_t topicKind, const EntityId_t &readerId,
                                   bool expectsInlineQos, InlineQosWriter *inlineQos);
    static bool addSubmessageDataFrag(CDRMessage_t *msg, const CacheChange_t *change,
    ...
    static bool addMessageHeartbeat(CDRMessage_t *msg, const GuidPrefix_t &guidprefix,
                                    ...
                                    const SequenceNumber_t &lastSN, Count_t count,
                                    bool isFinal, bool livelinessFlag);
    static bool addSubmessageHeartbeat(CDRMessage_t *msg, const EntityId_t &readerId,
                                       const EntityId_t &writerId,
                                       const SequenceNumber_t &firstSN,
                                       const SequenceNumber_t &lastSN, Count_t count,
                                       bool isFinal, bool livelinessFlag);
    ...
    static bool addMessageAcknack(CDRMessage_t *msg, const GuidPrefix_t &guidprefix,
                                  ...
                                  bool finalFlag);
    static bool addSubmessageAcknack(CDRMessage_t *msg, const EntityId_t &readerId,
                                     const EntityId_t &writerId,
                                     const SequenceNumberSet_t &SNSet, int32_t count,
                                     bool finalFlag);
    ...
    static bool addSubmessageNackFrag(CDRMessage_t *msg, const EntityId_t &readerId,
                                      const EntityId_t &writerId,
    ...
    static bool addSubmessageInfoSRC(CDRMessage_t *msg, const ProtocolVersion_t &version,
