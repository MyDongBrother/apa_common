...
/**
 * @enum MatchingStatus, indicates whether the matched publication/subscription method of
 * the PublisherListener or SubscriberListener has been called for a matching or a removal
