 ...
 *
 * This class holds the locators of a remote endpoint along with data required for the
 * locator selection algorithm. Can be easily integrated inside other classes, such as
 * @ref ReaderProxyData and @ref WriterProxyData.
 */
struct LocatorSelectorEntry
{
    ...
    struct EntryState
    {
         ...
         *
         * @param max_unicast_locators    Maximum number of unicast locators to held by
         * parent LocatorSelectorEntry.
         * @param max_multicast_locators  Maximum number of multicast locators to held by
         * parent LocatorSelectorEntry.
         */
