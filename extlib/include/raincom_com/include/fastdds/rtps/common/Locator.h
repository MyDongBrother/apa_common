...
/**
 * @brief Class Locator_t, uniquely identifies a communication channel for a particular
 * transport. For example, an address + port combination in the case of UDP.
 ...
 * unless \c kind is SHM \c port number
 *
