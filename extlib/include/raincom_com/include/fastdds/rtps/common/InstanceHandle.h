...
struct RTPS_DllAPI InstanceHandle_t
{
    ...
    // TODO Review this conversion once InstanceHandle_t is implemented as DDS standard
    // defines
 ...
 */
inline void iHandle2GUID(GUID_t &guid, const InstanceHandle_t &ihandle) noexcept
{
 ...
 */
inline bool operator<(const InstanceHandle_t &h1, const InstanceHandle_t &h2) noexcept
{
 ...
 * @return Stream operator.
 */
inline std::istream &operator>>(std::istream &input, InstanceHandle_t &iHandle)
{
