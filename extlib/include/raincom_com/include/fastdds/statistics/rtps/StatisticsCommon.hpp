...
class StatisticsListenersImpl
{
  ...
  protected:
    ...
    {
        static_assert(std::is_base_of<StatisticsAncillary, A>::value,
...
class StatisticsWriterImpl : protected StatisticsListenersImpl
{
  ...
  protected:
    ...
    /**
     * @brief Report a change on the number of DATA / DATAFRAG submessages sent for a
     * specific sample.
     * @param sample_identity SampleIdentity of the affected sample.
     * @param num_sent_submessages Current total number of submessages sent for the
     * affected sample.
     */
    ...
    /**
     * @brief Reports publication throughtput based on last added sample to writer's
     * history
...
class StatisticsReaderImpl : protected StatisticsListenersImpl
{
  ...
  protected:
     ...
     * @param source_timestamp Source timestamp received from the writer for the sample
     * being notified.
     */
    ...
    /**
     * @brief Reports subscription throughtput based on last added sample to reader's
     * history
...
class StatisticsWriterImpl
{
  protected:
    ...
    /**
     * @brief Report a change on the number of DATA / DATAFRAG submessages sent for a
     * specific sample. Parameter: SampleIdentity of the affected sample. Parameter:
     * Current total number of submessages sent for the affected sample.
     */
    ...
    /**
     * @brief Reports publication throughtput based on last added sample to writer's
     * history Parameter: size of the message sent
     */
...
class StatisticsReaderImpl
{
  ...
  protected:
    ...
    /**
     * @brief Reports subscription throughtput based on last added sample to reader's
     * history Parameter: size of the message received
     */
