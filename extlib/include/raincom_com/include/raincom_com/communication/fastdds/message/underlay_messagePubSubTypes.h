...
#error \
    Generated underlay_message is not compatible with current installed Fast DDS. Please, regenerate it with fastddsgen.
#endif // GEN_API_VER

/*!
 * @brief This class represents the TopicDataType of the type UnderlayMessage defined by
...
class UnderlayMessagePubSubType : public eprosima::fastdds::dds::TopicDataType
{
  public:
    ...
    eProsima_user_DllExport virtual ~UnderlayMessagePubSubType();
