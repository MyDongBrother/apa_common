...
{
/**
 * Class StringMatching used to match different strings against each other as defined by
 the POSIX fnmatch API (1003.2-1992 section B.6).
...
class RTPS_DllAPI StringMatching
{
  public:
     ...
     * It checks the string specified by the input argument to see if it matches the
