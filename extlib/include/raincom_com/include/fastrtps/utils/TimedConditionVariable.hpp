...
/*
   NOTE: Windows implementation temporary disabled due to aleatory high CPU consumption
 when calling _Cnd_timedwait function, making some tests to fail and very poor
 performance. Related task: #6274
...
class TimedConditionVariable
{
  public:
                    ...
                    std::function<bool()> predicate)
    {
        ...
        auto ns =
            std::chrono::time_point_cast<std::chrono::nanoseconds>(max_blocking_time) -
