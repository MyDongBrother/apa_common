...
inline rtps::Time_t MilliSeconds2Time_t(double millisec)
{
    ...
    t.fraction((uint32_t)((millisec - (double)t.seconds() * pow(10.0, 3)) / pow(10.0, 3) *
                          pow(2.0, 32)));
    return t;
}
...
inline rtps::Time_t MicroSeconds2Time_t(double microsec)
{
    ...
    t.fraction((uint32_t)((microsec - (double)t.seconds() * pow(10.0, 6)) / pow(10.0, 6) *
                          pow(2.0, 32)));
    return t;
}
...
inline rtps::Time_t MilliSecondsWithRandOffset2Time_t(double millisec, double randoff)
{
    ...
    millisec =
        millisec + (-randoff) +
        static_cast<double>(rand()) / (static_cast<double>(RAND_MAX / (2 * randoff)));
