...
class IPLocator
{
  public:
     ...
     */
    RTPS_DllAPI static void createLocator(int32_t kindin, const std::string &address,
    ...
    //! Sets locator's IPv4.
    RTPS_DllAPI static bool setIPv4(Locator_t &locator, octet o1, octet o2, octet o3,
                                    octet o4);
    ...
    //! Copies locator's IPv4.
    RTPS_DllAPI static bool setIPv4address(Locator_t &destlocator, const std::string &lan,
    ...
    //! Sets locator's IPv6.
    RTPS_DllAPI static bool setIPv6(Locator_t &locator, uint16_t group0, uint16_t group1,
                                    uint16_t group2, uint16_t group3, uint16_t group4,
                                    uint16_t group5, uint16_t group6, uint16_t group7);
    ...
    RTPS_DllAPI static bool setWan(Locator_t &locator, octet o1, octet o2, octet o3,
                                   octet o4);
    ...
    //! Checks if a both locators has the same IP address and physical port  (as in RTCP
    //! protocol).
    ...
    //! Resolve an address name by a DNS request and return the IP that this address
    //! references by a DNS server
