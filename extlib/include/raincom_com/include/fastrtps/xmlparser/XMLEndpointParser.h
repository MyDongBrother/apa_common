...
/**
 * Class StaticRTPSParticipantInfo, contains the information of writers and readers loaded
 *from the XML file.
...
/**
 * Class XMLEndpointParser used to parse the XML file that contains information about
 * remote endpoints.
