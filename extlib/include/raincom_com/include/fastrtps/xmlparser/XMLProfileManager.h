...
class XMLProfileManager
{
  public:
     ...
     * @return XMLP_ret::XML_OK if all profiles are correct, XMLP_ret::XML_NOK if some are
     * and some are not, XMLP_ret::XML_ERROR in other case.
     */
     ...
     * @return XMLP_ret::XML_OK on success, XMLP_ret::XML_ERROR in other case. Defaults
     * true.
     */
    RTPS_DllAPI static XMLP_ret fillParticipantAttributes(const std::string &profile_name,
     ...
     * true.
     */
    RTPS_DllAPI static XMLP_ret fillPublisherAttributes(const std::string &profile_name,
     ...
     * true.
     */
    RTPS_DllAPI static XMLP_ret fillSubscriberAttributes(const std::string &profile_name,
     ...
     * @return XMLP_ret::XML_OK on success, XMLP_ret::XML_ERROR in other case.
     */
    RTPS_DllAPI static XMLP_ret fillTopicAttributes(const std::string &profile_name,
     ...
     * @return XMLP_ret::XML_OK on success, XMLP_ret::XML_ERROR in other case.
     */
    RTPS_DllAPI static XMLP_ret fillRequesterAttributes(const std::string &profile_name,
     ...
     * @return XMLP_ret::XML_OK on success, XMLP_ret::XML_ERROR in other case.
     */
    RTPS_DllAPI static XMLP_ret fillReplierAttributes(const std::string &profile_name,
  ...
  private:
    ...
    RTPS_DllAPI static XMLP_ret extractParticipantProfile(up_base_node_t &profile,
                                                          const std::string &filename);

    RTPS_DllAPI static XMLP_ret extractPublisherProfile(up_base_node_t &profile,
                                                        const std::string &filename);

    RTPS_DllAPI static XMLP_ret extractSubscriberProfile(up_base_node_t &profile,
                                                         const std::string &filename);

    RTPS_DllAPI static XMLP_ret extractTopicProfile(up_base_node_t &profile,
                                                    const std::string &filename);

    RTPS_DllAPI static XMLP_ret extractRequesterProfile(up_base_node_t &profile,
                                                        const std::string &filename);

    RTPS_DllAPI static XMLP_ret extractReplierProfile(up_base_node_t &profile,
                                                      const std::string &filename);
