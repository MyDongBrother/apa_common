...
/**
 * Class SampleInfo_t with information that is provided along a sample when reading data
 * from a Subscriber.
...
class RTPS_DllAPI SampleInfo_t
{
  public:
    ...
    //! Ownership Strength of the writer of the sample (0 if the ownership kind is set to
