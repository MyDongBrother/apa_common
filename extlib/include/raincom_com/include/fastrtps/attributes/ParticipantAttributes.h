 ...
 * Participant. The Participants in the Publisher-Subscriber layer are only a container to
 * a RTPSParticipant, so their attributes are the same. Still to maintain the equivalence
 * this class is used to define them.
