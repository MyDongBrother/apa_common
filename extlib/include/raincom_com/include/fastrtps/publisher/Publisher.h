...
class RTPS_DllAPI Publisher
{
  ...
  public:
     ...
     * ReliabilityQosPolicy.max_blocking_time on PublisherAttributes defines this period
     * of time.
     * @par Calling example:
     ...
     * It gives and opportunity to the middleware to pre-configure itself to improve
     * performance.
     ...
     * @return True if correctly updated, false if ANY of the updated parameters cannot be
     * updated.
     */
