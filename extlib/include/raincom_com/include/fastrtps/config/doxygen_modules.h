 ...
 * This Module contains the Publisher Subscriber Layer created to facilitate the use of
 * the RTPS protocol.
 */

/** @defgroup FASTRTPS_ATTRIBUTES_MODULE Fast RTPS Attributes Module.
 * @ingroup FASTRTPS_MODULE
 * @brief Attributes class used to define the public entities that the user should use to
 * control this library.
 */
 ...
 * @ingroup RTPS_MODULE
 * This module contains all classes and methods associated with RTPSWriter and its
 * specifications, as well as other necessary classes.
 */

/** @defgroup READER_MODULE Reader Module
 * @ingroup RTPS_MODULE
 * This module contains all classes and methods associated with RTPSReader and its
 * specifications, as well as other necessary classes.
 */
 ...
 * @ingroup FASTRTPS_GENERAL_API
 * This module contains classes and methods associated with the management of all other
 * objects. The most important ones are the communication (ResourceSend and
 * ResourceListen) and event (ResourceEvent) resources.
 */
 ...
 * @ingroup FASTRTPS_GENERAL_API
 * Shared utilities that can be used by one or more classes in different modules. They are
 * not strictly part of the RTPS implementation but very useful to implement different
 * functionalities.
 */
...
/**
 * @namespace eprosima::fastrtps::rtps::TimeConv Auxiliary methods to convert to Time_t to
