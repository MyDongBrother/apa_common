...
/*!
 * @brief This class represents the structure ExtendedAnnotationParameterValue defined by
...
class ExtendedAnnotationParameterValue
{
  public:
     ...
     * @param x Reference to the object ExtendedAnnotationParameterValue that will be
     * copied.
     */
    RTPS_DllAPI ExtendedAnnotationParameterValue(
    ...
    RTPS_DllAPI static size_t getCdrSerializedSize(
        const ExtendedAnnotationParameterValue &data, size_t current_alignment = 0);
...
/*!
 * @brief This class represents the union AnnotationParameterValue defined by the user in
 * the IDL file.
 * @ingroup ANNOTATIONPARAMETERVALUE
 */
class AnnotationParameterValue
{
  public:
     ...
     * @return Serialized size.
     */
    RTPS_DllAPI static size_t getCdrSerializedSize(const AnnotationParameterValue &data,
...
/*!
 * @brief This class represents the structure AppliedAnnotationParameter defined by the
...
class AppliedAnnotationParameter
{
  public:
     ...
     * @return Serialized size.
     */
    RTPS_DllAPI static size_t getCdrSerializedSize(const AppliedAnnotationParameter &data,
                                                   size_t current_alignment = 0);
...
/*
   ...
   public:
    ...
    inline void paramname_hash(const NameHash &_paramname_hash) { m_paramname_hash =
   _paramname_hash; } inline void paramname_hash(NameHash &&_paramname_hash) {
   m_paramname_hash = std::move(_paramname_hash); } inline const NameHash&
   paramname_hash() const { return m_paramname_hash; } inline NameHash& paramname_hash() {
   return m_paramname_hash; }
    ...
    static size_t getCdrSerializedSize(const AppliedAnnotationParameter& data, size_t
   current_alignment = 0); void serialize(eprosima::fastcdr::Cdr &cdr) const; void
   deserialize(eprosima::fastcdr::Cdr &cdr); static size_t
   getKeyMaxCdrSerializedSize(size_t current_alignment = 0); static bool isKeyDefined();
...
class AppliedVerbatimAnnotation
{
  public:
    ...
    RTPS_DllAPI static size_t getCdrSerializedSize(const AppliedVerbatimAnnotation &data,
                                                   size_t current_alignment = 0);
...
class AppliedBuiltinMemberAnnotations
{
  public:
    ...
    RTPS_DllAPI static size_t getCdrSerializedSize(
        const AppliedBuiltinMemberAnnotations &data, size_t current_alignment = 0);
