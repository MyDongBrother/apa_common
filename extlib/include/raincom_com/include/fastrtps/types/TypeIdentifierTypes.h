...
/*!
 * @brief This class represents the structure StringSTypeDefn defined by the user in the
 * IDL file.
...
/*!
 * @brief This class represents the structure StringLTypeDefn defined by the user in the
 * IDL file.
 * @ingroup TYPEIDENTIFIERTYPES
 */
...
/*!
 * @brief This class represents the structure PlainCollectionHeader defined by the user in
 * the IDL file.
 * @ingroup TYPEIDENTIFIERTYPES
 */
class PlainCollectionHeader final
{
  public:
     ...
     * @return Serialized size.
     */
    RTPS_DllAPI static size_t getCdrSerializedSize(const PlainCollectionHeader &data,
                                                   size_t current_alignment = 0);
...
/*!
 * @brief This class represents the structure PlainSequenceSElemDefn defined by the user
 * in the IDL file.
 * @ingroup TYPEIDENTIFIERTYPES
 */
class PlainSequenceSElemDefn final
{
  public:
     ...
     */
    RTPS_DllAPI inline const PlainCollectionHeader &header() const { return m_header; }
     ...
     * @return Serialized size.
     */
    RTPS_DllAPI static size_t getCdrSerializedSize(const PlainSequenceSElemDefn &data,
                                                   size_t current_alignment = 0);
...
/*!
 * @brief This class represents the structure PlainSequenceLElemDefn defined by the user
 * in the IDL file.
 * @ingroup TYPEIDENTIFIERTYPES
 */
class PlainSequenceLElemDefn final
{
  public:
     ...
     * @return Serialized size.
     */
    RTPS_DllAPI static size_t getCdrSerializedSize(const PlainSequenceLElemDefn &data,
                                                   size_t current_alignment = 0);
...
/*!
 * @brief This class represents the structure PlainArraySElemDefn defined by the user in
 * the IDL file.
 * @ingroup TYPEIDENTIFIERTYPES
 */
class PlainArraySElemDefn final
{
  public:
     ...
     * @return Serialized size.
     */
    RTPS_DllAPI static size_t getCdrSerializedSize(const PlainArraySElemDefn &data,
                                                   size_t current_alignment = 0);
...
/*!
 * @brief This class represents the structure PlainArrayLElemDefn defined by the user in
 * the IDL file.
 * @ingroup TYPEIDENTIFIERTYPES
 */
class PlainArrayLElemDefn final
{
  public:
     ...
     * @return Serialized size.
     */
    RTPS_DllAPI static size_t getCdrSerializedSize(const PlainArrayLElemDefn &data,
                                                   size_t current_alignment = 0);
...
/*!
 * @brief This class represents the structure PlainMapSTypeDefn defined by the user in the
 * IDL file.
 * @ingroup TYPEIDENTIFIERTYPES
 */
class PlainMapSTypeDefn final
{
  public:
     ...
     */
    RTPS_DllAPI inline CollectionElementFlag key_flags() const { return m_key_flags; }
     ...
     */
    RTPS_DllAPI inline TypeIdentifier *key_identifier() { return m_key_identifier; }
...
/*!
 * @brief This class represents the structure PlainMapLTypeDefn defined by the user in the
 * IDL file.
 * @ingroup TYPEIDENTIFIERTYPES
 */
...
/*!
 * @brief This class represents the structure StronglyConnectedComponentId defined by the
...
class StronglyConnectedComponentId final
{
  public:
     ...
     */
    RTPS_DllAPI inline TypeObjectHashId &sc_component_id() { return m_sc_component_id; }
    /*!
     ...
     */
    RTPS_DllAPI inline void scc_index(int32_t _scc_index) { m_scc_index = _scc_index; }
    ...
    RTPS_DllAPI static size_t getCdrSerializedSize(
        const StronglyConnectedComponentId &data, size_t current_alignment = 0);
...
/*!
 * @brief This class represents the structure ExtendedTypeDefn defined by the user in the
 * IDL file.
 * @ingroup TYPEIDENTIFIERTYPES
 */
