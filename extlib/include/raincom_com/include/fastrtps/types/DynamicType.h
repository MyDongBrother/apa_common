...
class DynamicType
{
  protected:
    ...
    // This method is used by Dynamic Data to override the name of the types based on
    // ALIAS.
  ...
  public:
    ...
    RTPS_DllAPI const TypeDescriptor *get_type_descriptor() const { return descriptor_; }
