...
enum CommentPlacement
{
    ...
    commentAfter, ///< a comment on the line after a value (only make sense for root
                  ///< value)
...
/** \brief Experimental and untested: represents an element of the "path" to access a
 * node.
 */
class PathArgument
{
...
class Path
{
  public:
    ...
    /// Creates the "path" to access the specified node and returns a reference on the
    /// node.
...
/** \brief Experimental do not use: Allocator to customize member name and string value
 * memory management done by Value.
 *
