 ...
 *
 * \sa Scaling(), class DiagonalMatrix, MatrixBase::asDiagonal(), class Translation, class
 * Transform
 */
...
class UniformScaling
{
  ...
  public:
    ...
    inline
        typename internal::uniformscaling_times_affine_returntype<Scalar, Dim, Mode>::type
