...
template <typename IndexType>
static void init_scoring(IndexType n_row, IndexType n_col, RowStructure<IndexType> Row[],
...
static IndexType find_ordering(IndexType n_row, IndexType n_col, IndexType Alen,
                               RowStructure<IndexType> Row[],
                               ColStructure<IndexType> Col[], IndexType A[],
                               IndexType head[], IndexType n_col2, IndexType max_deg,
                               IndexType pfree);
                             ...
                             IndexType stats[NStats])
{
    ...
    ngarbage = Colamd::find_ordering(n_row, n_col, Alen, Row, Col, A, p, n_col2, max_deg,
                                     2 * nnz);
