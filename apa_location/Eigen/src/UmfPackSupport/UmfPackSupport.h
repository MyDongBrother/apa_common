...
// Symbolic
inline int umfpack_symbolic(int n_row, int n_col, const int Ap[], const int Ai[],
...
inline int umfpack_numeric(const int Ap[], const int Ai[],
                           ...
                           double Info[UMFPACK_INFO])
{
    return umfpack_zi_numeric(Ap, Ai, &numext::real_ref(Ax[0]), 0, Symbolic, Numeric,
                              Control, Info);
}
...
inline SuiteSparse_long umfpack_numeric(const SuiteSparse_long Ap[],
                                        ...
                                        double Info[UMFPACK_INFO])
{
    return umfpack_zl_numeric(Ap, Ai, &numext::real_ref(Ax[0]), 0, Symbolic, Numeric,
                              Control, Info);
}
                         ...
                         const double Control[UMFPACK_CONTROL], double Info[UMFPACK_INFO])
{
    return umfpack_zi_solve(sys, Ap, Ai, &numext::real_ref(Ax[0]), 0,
                            &numext::real_ref(X[0]), 0, &numext::real_ref(B[0]), 0,
...
// Get Lunz
inline int umfpack_get_lunz(int *lnz, int *unz, int *n_row, int *n_col, int *nz_udiag,
                            void *Numeric, double)
{
...
inline SuiteSparse_long umfpack_get_lunz(SuiteSparse_long *lnz, SuiteSparse_long *unz,
...
// Get Numeric
inline int umfpack_get_numeric(int Lp[], int Lj[], double Lx[], int Up[], int Ui[],
...
inline int umfpack_get_numeric(int Lp[], int Lj[], std::complex<double> Lx[], int Up[],
                               ...
                               void *Numeric)
{
    ...
    return umfpack_zi_get_numeric(Lp, Lj, Lx ? &lx0_real : 0, 0, Up, Ui,
                                  Ux ? &ux0_real : 0, 0, P, Q, Dx ? &dx0_real : 0, 0,
                                  do_recip, Rs, Numeric);
}
inline SuiteSparse_long umfpack_get_numeric(SuiteSparse_long Lp[], SuiteSparse_long Lj[],
                                            double Lx[], SuiteSparse_long Up[],
...
inline SuiteSparse_long umfpack_get_determinant(std::complex<double> *Mx, double *Ex,
                                                void *NumericHandle,
                                                double User_Info[UMFPACK_INFO],
                                                SuiteSparse_long)
{
 ...
 * to get a compressed matrix. \tparam _MatrixType the type of the sparse matrix A, it
