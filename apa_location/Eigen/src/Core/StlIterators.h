...
class indexed_based_stl_iterator_base
{
  protected:
    ...
    typedef typename internal::conditional<internal::is_const<XprType>::value,
        ...
        other_iterator;
    // NOTE: in C++03 we cannot declare friend classes through typedefs because we need to
    // write friend class:
...
class pointer_based_stl_iterator
{
  ...
  public:
    ...
    friend pointer_based_stl_iterator operator+(const pointer_based_stl_iterator &a,
                                                Index b)
    {
    ...
    friend pointer_based_stl_iterator operator+(Index a,
    ...
    : public indexed_based_stl_iterator_base<generic_randaccess_stl_iterator<XprType>>
{
  ...
  protected:
    ...
    // typedef typename internal::conditional<bool(has_direct_access), const value_type&,
    // const value_type>::type read_only_ref_t;
...
struct indexed_based_stl_iterator_traits<subvector_stl_iterator<_XprType, Direction>>
{
    ...
    typedef subvector_stl_iterator<typename internal::remove_const<XprType>::type,
                                   Direction>
        non_const_iterator;
    typedef subvector_stl_iterator<typename internal::add_const<XprType>::type, Direction>
        const_iterator;
};
    ...
    : public indexed_based_stl_iterator_base<subvector_stl_iterator<XprType, Direction>>
{
  protected:
    ...
    typedef
        typename internal::conditional<Direction == Vertical, typename XprType::ColXpr,
...
{
    typedef _XprType XprType;
    typedef subvector_stl_reverse_iterator<typename internal::remove_const<XprType>::type,
                                           Direction>
        non_const_iterator;
    typedef subvector_stl_reverse_iterator<typename internal::add_const<XprType>::type,
                                           Direction>
        const_iterator;
};
...
/** returns a read-only const_iterator to the element following the last element of the 1D
