 ...
 *
 *  - in EIGEN_STATIC_ASSERT(CONDITION,MSG) the parameter CONDITION must be a compile time
 * boolean expression, and MSG an enum listed in struct internal::static_assertion<true>
 *
...
#define EIGEN_STATIC_ASSERT_ARRAYXPR(Derived)                                         \
    EIGEN_STATIC_ASSERT(                                                              \
        (Eigen::internal::is_same<typename Eigen::internal::traits<Derived>::XprKind, \
                                  ArrayXpr>::value),                                  \
