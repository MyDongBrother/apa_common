 ...
 * \tparam Cols the number of columns of the reshape we are taking at compile time
 * (optional) \tparam Order can be ColMajor or RowMajor, default is ColMajor.
 *
...
template <typename XprType, int Rows, int Cols, int Order>
class Reshaped : public ReshapedImpl<XprType, Rows, Cols, Order,
                        ...
                        typename Reshaped<ArgType, Rows, Cols, Order>::PlainObject>
{
    ...
    {
        // TODO: for the 3.4 release, this should be turned to an internal assertion, but
