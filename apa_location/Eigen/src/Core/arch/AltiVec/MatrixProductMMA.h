...
EIGEN_ALWAYS_INLINE void storeAccumulator(Index i, Index j, const DataMapper &data,
...
template <typename DataMapper, typename Index, typename Packet, typename Packetc,
          const Index accColsC, int N>
EIGEN_ALWAYS_INLINE void storeComplexAccumulator(Index i, Index j, const DataMapper &data,
...
template <typename LhsPacket, typename RhsPacket, bool NegativeAccumulate>
EIGEN_ALWAYS_INLINE void pgerMMA(__vector_quad *acc, const PacketBlock<Packet2d, 2> &a,
                                 const Packet2d &b)
{
...
template <typename Scalar, typename Packet, typename RhsPacket, bool ConjugateLhs,
          bool ConjugateRhs, bool LhsIsReal, bool RhsIsReal>
EIGEN_ALWAYS_INLINE void pgercMMA(__vector_quad *accReal, __vector_quad *accImag,
                                  const Packet &lhsV, const Packet &lhsVi,
                                  const RhsPacket &rhsV, const RhsPacket &rhsVi)
{
...
#define MICRO_MMA_TYPE_PEEL(func, func2, type, peel)                                    \
    ...
    {                                                                                   \
        ...
        func(0, type, peel) func(1, type, peel) func(2, type, peel) func(3, type, peel) \
            func(4, type, peel) func(5, type, peel) func(6, type, peel)                 \
                func(7, type, peel)                                                     \
    }                                                                                   \
    else                                                                                \
    {                                                                                   \
...
template <int unroll_factor, typename Scalar, typename Packet, typename RhsPacket,
...
#define MICRO_COMPLEX_MMA_WORK_ONE(iter, type, peel)                                 \
    ...
    {                                                                                \
        pgercMMA<Scalar, Packet, type, ConjugateLhs, ConjugateRhs, LhsIsReal,        \
                 RhsIsReal>(&accReal##iter, &accImag##iter, lhsV##iter, lhsVi##iter, \
                            rhsV##peel, rhsVi##peel);                                \
    }
...
#define MICRO_COMPLEX_MMA_STORE_ONE(iter)                                           \
    ...
    {                                                                               \
        storeComplexAccumulator<DataMapper, Index, Packet, Packetc, accColsC, 0>(   \
            row + iter * accCols, col, res, pAlphaReal, pAlphaImag, &accReal##iter, \
            &accImag##iter);                                                        \
    }
...
#define MAX_COMPLEX_MMA_UNROLL 4
        ...
        {
            gemm_complex_unrolled_MMA_iteration<MAX_COMPLEX_MMA_UNROLL, Scalar, Packet,
                                                Packetc, RhsPacket, DataMapper, Index,
                                                accRows, accCols, ConjugateLhs,
