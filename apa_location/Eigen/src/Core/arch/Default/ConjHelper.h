...
struct conj_helper
{
    ...
    EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE ResultType pmul(const LhsType &x,
                                                          const RhsType &y) const
    {
...
struct conj_helper<LhsScalar, RhsScalar, true, true>
{
    ...
    EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE ResultType pmul(const LhsScalar &x,
...
struct conj_helper<Packet, Packet, ConjLhs, ConjRhs>
{
    ...
    EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE Packet pmadd(const Packet &x, const Packet &y,
